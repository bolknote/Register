...
},M=O("//","$"),A=O("/\\*","\\*/"),S=O("#","$");var q=Object.freeze({
...
const[e,s]=i
;if(A.addText(t),t="",c[a]=(c[a]||0)+1,c[a]<=7&&(q+=s),e.startsWith("_"))t+=n[0];else{
const t=y.classNameAliases[e]||e;p(n[0],t)}}else t+=n[0]
;e=O.keywordPatternRe.lastIndex,n=O.keywordPatternRe.exec(S)}var s
...
""!==e&&(A.startScope(n),A.addText(e),A.endScope())}function m(e,n){let t=1
;const s=n.length-1;for(;t<=s;){if(!e._emit[t]){t++;continue}
const s=y.classNameAliases[e[t]]||e[t],a=n[t];s?p(a,s):(S=a,l(),S=""),t++}}
function u(e,n){
return e.scope&&"string"==typeof e.scope&&A.openNode(y.classNameAliases[e.scope]||e.scope),
e.beginScope&&(e.beginScope._wrap?(p(S,y.classNameAliases[e.beginScope._wrap]||e.beginScope._wrap),
...
m(O.endScope,e)):i.skip?S+=n:(i.returnEnd||i.excludeEnd||(S+=n),
...
let E={};function w(s,i){const o=i&&i[0];if(S+=s,null==o)return d(),0
;if("begin"===E.type&&"end"===i.type&&E.index===i.index&&""===o){
if(S+=t.slice(i.index,i.index+1),!r){const n=Error(`0 width match regex (${e})`)
...
;return s.skip?S+=t:(s.excludeBegin&&(S+=t),
d(),s.returnBegin||s.excludeBegin||(S=t)),u(s,e),s.returnBegin?0:t.length})(i)
;if("illegal"===i.type&&!a){
...
;const x=W(y);let k="",O=i||x;const M={},A=new g.__emitter(g);(()=>{const e=[]
...
;C=e.index+n}w(t.substring(C))}return A.finalize(),k=A.toHTML(),{language:e,
...
context:t.slice(C-100,C+100),mode:n.mode,resultSoFar:k},_emitter:A};if(r)return{
...
className:{2:"keyword"}},i={match:u(/\./,b(...Ae)),relevance:0
},r=Ae.filter((e=>"string"==typeof e)).concat(["_|0"]),o={variants:[{
className:"keyword",
match:b(...Ae.filter((e=>"string"!=typeof e)).concat(Me).map(xe),...Oe)}]},c={
$pattern:b(/\b\w+/,/#\w+/),keyword:r.concat(Ce),literal:Se},l=[a,i,o],p=[{
...
scope:"regexp",variants:[M("###"),M("##"),M("#"),O]},S={match:u(/`/,Be,/`/)
},q=[S,{className:"variable",match:/\$\d+/},{className:"variable",
...
},...s,A,...l,...p,...g,f,x,...q,...C,T]},D={begin:/</,end:/>/,
...
match:[/(func|macro)/,/\s+/,b(S.match,Be,De)],className:{1:"keyword",
...
1:"keyword",3:"title"},contains:[T],keywords:[...qe,...Se],end:/}/},j={
...
contains:[...s],relevance:0},A,...l,...p,...g,f,x,...q,...C,T,I]}},
grmr_typescript:e=>{
