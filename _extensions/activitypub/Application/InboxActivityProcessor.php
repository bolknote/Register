...
final readonly class InboxActivityProcessor
{
    ...
    private function followResponse(
        ...
        if (!$localActivity instanceof \s2_extensions\activitypub\Infrastructure\StoredActivityRepresentation) {
    ...
    private function localActivityFromUrl(string $url): ?\s2_extensions\activitypub\Infrastructure\StoredActivityRepresentation
    {
