...
use Register\Extension\activitypub\Controller\ActivityController;
use Register\Extension\activitypub\Controller\ActorCollectionController;
use Register\Extension\activitypub\Controller\ActorController;
use Register\Extension\activitypub\Controller\ActorKeyController;
use Register\Extension\activitypub\Controller\InboxController;
use Register\Extension\activitypub\Controller\NodeInfoController;
use Register\Extension\activitypub\Controller\NodeInfoDiscoveryController;
use Register\Extension\activitypub\Controller\ObjectController;
use Register\Extension\activitypub\Controller\ObjectRepliesController;
...
use Register\Extension\activitypub\Infrastructure\ActivityPubBackupContributor;
...
use Register\Extension\activitypub\Presentation\HtmlFederationLinker;
...
final class Extension implements ExtensionInterface
{
    ...
    public function buildContainer(Container $container): void
    {
        ...
        $container->set(ContentObjectDocumentBuilder::class, static fn(Container $container): ContentObjectDocumentBuilder => new ContentObjectDocumentBuilder(
            $container->get(PortableHtmlSanitizer::class),
            $container->get(DynamicConfigProvider::class)->getStringProxy('REGISTER_LANGUAGE')->get(),
        ...
        $container->set(NodeInfoController::class, static fn(Container $container): NodeInfoController => new NodeInfoController(
            ...
            $container->get(LocalFederationRepository::class),
            $container->get(ActivityPubResponseFactory::class),
            $container->get(DynamicConfigProvider::class)->getStringProxy('REGISTER_SITE_NAME'),
