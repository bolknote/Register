...
class DynamicConfigProvider implements StatefulServiceInterface
{
    ...
    private function ensureParamsAreLoaded(): void
    {
        ...
        $data = register_call_without_warnings(fn(): mixed => include $this->fileName);
        if (\is_array($data)) {
            $secretStore = $this->secretStore;
            if (!$secretStore instanceof \Register\Core\Config\DynamicSecretStore) {
                $this->params = $data;
                return;
            }
    ...
    {
        if (!$this->dbLayer instanceof \Register\Core\Pdo\DbLayer) {
