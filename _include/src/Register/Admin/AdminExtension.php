...
use Register\Admin\Dashboard\DashboardConfigExtender;
use Register\Admin\Dashboard\DashboardCompressionProvider;
use Register\Admin\Dashboard\DashboardDatabaseProvider;
use Register\Admin\Dashboard\DashboardEnvironmentProvider;
use Register\Admin\Dashboard\DashboardMailProvider;
use Register\Admin\Dashboard\DashboardPerformanceProvider;
use Register\Admin\Dashboard\DashboardPageCacheProvider;
use Register\Admin\Dashboard\DashboardQueryProfilerProvider;
use Register\Admin\Dashboard\DashboardSecurityProvider;
...
use Register\Admin\Controller\BulkListActionController;
use Register\Admin\Controller\SavedListViewController;
use Register\Admin\Event\RedirectFromPublicEvent;
use Register\Admin\Event\AdminAjaxControllerMapEvent;
use Register\Admin\Mail\MailTestController;
use Register\Admin\Mail\MailTestToken;
use Register\Admin\Profiler\QueryProfilerController;
...
use Register\Admin\Picture\MediaConfigExtender;
use Register\Admin\Picture\PictureManager;
use Register\Admin\Picture\PictureReserveManager;
use Register\Admin\Security\ReauthenticationAdminConfigExtender;
use Register\Admin\WebAuthn\WebAuthnAdminConfigExtender;
use Register\Admin\WebAuthn\WebAuthnAdminController;
...
use Register\Admin\Extensions\ExtensionManagerAdapter;
...
class AdminExtension implements ExtensionInterface
{
    ...
    public function buildContainer(Container $container): void
    {
        ...
        $container->set(ResourceProvider::class, fn(Container $container): \Register\Admin\ResourceProvider => new ResourceProvider(
            $container->getStringParameter('root_dir'),
        ));

        $container->set(DynamicConfigFormBuilder::class, fn(Container $container): \Register\Admin\DynamicConfigFormBuilder => new DynamicConfigFormBuilder(
            $container->get(PermissionChecker::class),
            $container->get(Translator::class),
            $container->get(TypeTransformer::class),
        ...
        $container->set(AdminConfigProvider::class, function (Container $container): \Register\Admin\AdminConfigProvider {
        ...
        $container->set(CommentControllerFactory::class, fn(Container $container): \Register\Admin\Controller\CommentControllerFactory => new CommentControllerFactory(
            $container->get(SpamFeedbackService::class),
            $container->get(AdminMutationGuard::class),
            $container->get(CommentRepository::class),
            $container->get(\Register\Live\LiveUpdateRepository::class),
        ...
        $container->set(AdminRequestHandler::class, fn(Container $container): \Register\Admin\AdminRequestHandler => new AdminRequestHandler(
            $container->get(RequestStack::class),
            $container->get(AuthManager::class),
        ...
        $container->set(AdminAjaxRequestHandler::class, fn(Container $container): \Register\Admin\AdminAjaxRequestHandler => new AdminAjaxRequestHandler(
            $container->get(RequestStack::class),
            $container->get(AuthManager::class),
            $container->get(PermissionChecker::class),
            $container->get(SameOriginRequestGuard::class),
        ...
        // Structure page
        $container->set(ArticleManager::class, function (Container $container): \Register\Model\ArticleManager {
            $provider = $container->get(DynamicConfigProvider::class);
        ...
        $container->set(SiteStructureExtender::class, fn(Container $container): \Register\Admin\SiteStructureExtender => new SiteStructureExtender(
            $container->get(TemplateRenderer::class),
        ), [AdminConfigExtenderInterface::class]);
        ...
        $container->set(ExtensionManagerAdapter::class, fn(Container $container): ExtensionManagerAdapter => new ExtensionManagerAdapter(
        ...
        // Dashboard providers
        $container->set(DashboardConfigExtender::class, fn(Container $container): \Register\Admin\Dashboard\DashboardConfigExtender => new DashboardConfigExtender(
        ...
        $container->set(DashboardEnvironmentProvider::class, fn(Container $container): \Register\Admin\Dashboard\DashboardEnvironmentProvider => new DashboardEnvironmentProvider(
            $container->get(Translator::class),
            $container->get(TemplateRenderer::class),
        ...
        $container->set(DashboardDatabaseProvider::class, fn(Container $container): \Register\Admin\Dashboard\DashboardDatabaseProvider => new DashboardDatabaseProvider(
            $container->get(DbLayer::class),
        ...
        $container->set(PictureFileNameHelper::class, fn(Container $container): \Register\Admin\Picture\PictureFileNameHelper => new PictureFileNameHelper(
            $container->get(Translator::class),
        ...
        $container->set(PictureReserveManager::class, fn(Container $container): \Register\Admin\Picture\PictureReserveManager => new PictureReserveManager(
            $container->get(PictureFileNameHelper::class),
            $container->getStringParameter('image_dir'),
            $container->getStringParameter('cache_dir'),
        ));

        $container->set(PictureManager::class, function (Container $container): \Register\Admin\Picture\PictureManager {
