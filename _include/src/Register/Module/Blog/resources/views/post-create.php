...
<div class="post-create-slot<?php echo $always_visible ? ' is-always-visible' : ''; ?>" data-post-create-slot>
    <button class="post-create-start" type="button" title="<?php echo register_htmlencode($trans('Create new')); ?>" aria-label="<?php echo register_htmlencode($trans('Create new')); ?>" data-editor-shortcut="create">
