...
return [
    ...
    'Post recovery server changed' => 'На сайте уже есть более новая версия. Восстановление заменит текст только в редакторе; проверьте его перед сохранением.',
    'Post recovery restore' => 'Восстановить текст',
    'Post recovery discard' => 'Удалить локальную копию',
    'Post recovery discard warning' => 'Удалить эту несохранённую копию? Текст на сайте останется без изменений.',
    'Post recovery restored' => 'Текст восстановлен. Проверьте его перед сохранением. Локальная копия хранится до 7 дней.',
    'Post recovery unavailable' => 'Не удалось сохранить локальную копию. Оставьте вкладку открытой и сохраните пост, когда появится соединение.',
    'Post recovery media' => 'Незавершённые загрузки нужно добавить заново. Проверьте изображения и аудио перед сохранением.',
    'Post recovery markup' => 'Нестандартная разметка, скрипты и встраиваемые объекты в локальной копии удалены. Проверьте оформление и медиа перед сохранением.',
    ...
    'Post tags' => 'Теги',
    'Post tag suggestions' => 'Подсказки тегов',
    ...
    'Discard unsaved post changes' => 'Отменить несохранённые изменения?',
    'Discard post changes warning' => 'Все изменения после открытия редактора будут потеряны.',
    'Discard post changes' => 'Не сохранять',
    'Continue post editing' => 'Продолжить редактирование',
    ...
    'Post text crossed image boundary' => 'Часть текста попала внутрь изображения. Ничего не сохранено; текст остался в редакторе.',
    ...
    'AI image alt applied' => 'ИИ добавил alt-текст.',
    'AI image alt failed' => 'Не удалось создать alt-текст. Добавьте его вручную или повторите.',
    'Generate image alt with AI' => 'Создать alt-текст с ИИ',
    ...
    'Invalid AI image' => 'Некорректное превью изображения для ИИ.',
