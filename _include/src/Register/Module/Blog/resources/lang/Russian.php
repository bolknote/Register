...
return [
    ...
    'Post editor loading' => 'Загружаем редактор…',
    'Post editor loading failed' => 'Не удалось загрузить редактор. Откройте полный редактор и попробуйте снова.',
    'Post editor preview failed' => 'Не удалось построить предпросмотр.',
