...
final class TranslationProvider implements TranslationProviderInterface
{
    ...
    private function russian(): array
    {
        return [
            ...
            'Link pagination'                     => 'Страницы списка ссылок',
            'Link previous page'                  => 'Предыдущая страница',
            'Link next page'                      => 'Следующая страница',
    ...
    private function english(): array
    {
        return [
            ...
            'Link pagination'                     => 'Link list pages',
            'Link previous page'                  => 'Previous page',
