...
{
    /**
     * @param array<int|string, string> $titleWords   Keys are the positions of corresponding words.
     * @param array<int|string, string> $keywords     Keys are the positions of corresponding words.
     * @param array<int|string, string> $contentWords Keys are the positions of corresponding words.
     */
