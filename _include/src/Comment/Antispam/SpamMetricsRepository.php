...
final readonly class SpamMetricsRepository
{
    ...
    public function describeModel(?int $now = null): array
    {
        ...
        $textMetrics = $textModel instanceof \Register\Core\Comment\Antispam\SpamTextModel ? $textModel->metrics : [];
        ...
        return [
            ...
            'text_model_features'=> $textModel instanceof \Register\Core\Comment\Antispam\SpamTextModel ? count($textModel->weights) : 0,
