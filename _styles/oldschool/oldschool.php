...
return (new AssetPack(__DIR__))
    ...
    ->addCss('../../_assets/register/local-time.css?v=' . (string)\filemtime(__DIR__ . '/../../_assets/register/local-time.css'))
    ->addHeadJs('../../_assets/register/local-time.js?v=' . (string)\filemtime(__DIR__ . '/../../_assets/register/local-time.js'))
