...
final class SnippetTest extends Unit
{
    ...
    public function testSnippetsUnique(): void
    {
        ...
        $snippet
            ...
            ->attachSnippetLine(4, 4 + 3, new SnippetLine('Try to test 1.', SnippetSource::FORMAT_PLAIN_TEXT, $stemmer, ['test'], 1))
    ...
    public function testEmptySnippet(): void
    {
        $stemmer = new PorterStemmerEnglish();
        $snippet = new Snippet('<i>%s</i>', new SnippetLine('introduction', SnippetSource::FORMAT_PLAIN_TEXT, $stemmer, [], 0.0));
        $snippet->toString();
