...
final class SnippetTextHelperTest extends Unit
{
    ...
    {
        $result = SnippetTextHelper::prepareForOutput('<script>alert(1)</script>', SnippetSource::FORMAT_PLAIN_TEXT, true);
    ...
    {
        $result = SnippetTextHelper::prepareForOutput('\\iDanger\\I text', SnippetSource::FORMAT_INTERNAL, true);

        self::assertSame('<i>Danger</i> text', $result);
    }
}
