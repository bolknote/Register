...
final class PageCachePoolFactoryTest extends TestCase
{
    ...
    public function testUsesAnIsolatedFilesystemFallbackInCli(): void
    {
        ...
        self::assertSame($this->temporaryDirectory . '/pages_v9', $pools->filesystemDirectory);
        ...
        self::assertDirectoryExists($this->temporaryDirectory . '/pages_v9');
    ...
    {
        self::assertSame('pages_v9', PageCachePoolFactory::filesystemNamespace());
