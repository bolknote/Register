...
final class PageCachePoolFactoryTest extends TestCase
{
    ...
    public function testUsesAnIsolatedFilesystemFallbackInCli(): void
    {
        ...
        self::assertSame($this->temporaryDirectory . '/pages_v5', $pools->filesystemDirectory);
        ...
        self::assertDirectoryExists($this->temporaryDirectory . '/pages_v5');
    ...
    {
        self::assertSame('pages_v5', PageCachePoolFactory::filesystemNamespace());
