...
final class ModuleTest extends Unit
{
    public function testAddsOnlyTheSmallLocalLoaderToEveryPage(): void
    {
        ...
        $loaderModifiedAt = filemtime($publicRoot . '_assets/register/audio-player/loader.js');
        self::assertIsInt($loaderModifiedAt);

        self::assertSame('', $assetPack->getStyles('', null));
        self::assertSame(
            '<script src="/register/_assets/register/audio-player/loader.js?v=' . $loaderModifiedAt . '" defer></script>',
