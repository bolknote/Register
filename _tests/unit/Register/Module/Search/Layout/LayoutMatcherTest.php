...
namespace unit\Register\Module\Search\Layout;

use Codeception\Test\Unit;
use Register\Module\Search\Layout\LayoutMatcher;

/**
 * @group layout-matcher
 */
final class LayoutMatcherTest extends Unit
{
    public static function distributeItemsProvider(): \Iterator
    {
        yield 'case 1' => [
            'mapItemToGroups' => [
                [0, 1, 2],
     ...
     * @param array<int, non-empty-list<int>> $mapGroupToItems
     * @param array<int, non-empty-list<int>> $mapItemToGroups
     * @param list<int> $blocksInGroup
     * @param list<list<int>>|null $expectedResult
     */
