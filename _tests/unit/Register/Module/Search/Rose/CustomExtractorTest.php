...
namespace unit\Register\Module\Search\Rose;
 ...
 * @group extract
 */
final class CustomExtractorTest extends Unit
{
     ...
     */
    public function testCustomExtractor(string $htmlText, string $resultText, ?array $words = null, ?string $images = null): void
    {
        $domExtractor = $this->domExtractor ?? throw new \LogicException('Test extractor was not initialized.');
        $extractionResult = $domExtractor->extract($htmlText);
