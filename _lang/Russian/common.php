...
return [
    ...
    'No password: we will send a one-time link.' => 'Без пароля: отправим одноразовую ссылку на почту.',
    'Add your name' => 'Указать имя',
    'optional' => 'необязательно',
    'Send sign-in link' => 'Прислать ссылку',
    'Sending' => 'Отправляем…',
    'Site login and password' => 'Логин и пароль сайта',
    'Signing in' => 'Входим…',
